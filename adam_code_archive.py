...
def main():
    ...
    home_folder = str(Path.home()) # uses the method Path.home() to find the home directory in any OS
    output_folder = home_folder + '/Documents/' # appends a subdirectory within it.
    filename = 'Harmonic-init.pdf' # defines the filename the output is to be saved in
